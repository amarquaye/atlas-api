...
# TODO: Remove soon as it a beta version using httpx.
@app.get("/api/v2", tags=["Endpoints"])
@limiter.limit("3/minute")
async def search(
    request: Request,
    query: str = Query(None, description="Query to search the web"),
...
# TODO: Remove soon as it is a beta version using httpx.
@app.get("/api/scraper/v2", tags=["Endpoints"])
@limiter.limit("3/minute")
async def scrape(
    request: Request,
    query: str = Query(None, description="Query to search the web"),
